...
The first line gets the limit from the request and sets it to a variable called limit. If no limit was sent in the request, a default limit of 10 is applied.
If a limit of more than 10(> 10) was sent in the request, we default it back to 10, before proceeding.
